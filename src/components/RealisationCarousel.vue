...
onMounted(() => {
  ...
  if (window.jQuery) {
    ...
    const owl = $(".custom-carousel").owlCarousel({
      autoWidth: true,
      loop: true,
      rtl: false, // Attention: ton JS disait 'true', mais souvent c'est 'false' pour l'Europe
    ...
    // Logique de clic pour l'effet d'expansion
